!macro customInstall
  DetailPrint "Installing codex ctx command shim..."
  ...
  Pop $0
  DetailPrint "codex ctx command shim setup result: $0"
!macroend

!macro customUnInstall
  DetailPrint "Removing codex ctx command shim..."
  ...
  Pop $0
  DetailPrint "codex ctx command shim removal result: $0"
!macroend
